...
export default function MobileOnboarding() {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 32, padding: '40px 24px', fontFamily: 'var(--font-body)', background: '#060F2A', minHeight: '100vh', justifyContent: 'center' }}>
        <div style={{ width: 72, height: 72, borderRadius: 20, background: 'linear-gradient(135deg, #1D4ED8, #16A34A)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 30, fontWeight: 800, color: 'white', letterSpacing: '-0.04em', marginBottom: 12 }}>InsureNG Mobile</h1>
